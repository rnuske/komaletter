\documentclass[version=last,$if(fontsize)$$fontsize$$else$12pt$endif$,$if(lco)$$lco$$else$$lco_default$$endif$,$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$paper,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{scrlttr2}
$if(fontfamily)$
